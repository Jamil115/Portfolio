...
export default function Hero() {
  return (
    <div className="flex flex-col justify-center items-center h-[730px] border-2 rounded-4xl mx-64 my-8">
        ...
        <div className="text-center">
            ...
            <h1 className="font-bold text-5xl mb-4 text-yellow-300 font-serif">Jamil Khan Riyed</h1>
            <p className="text-xl font-semibold mb-7">I'm a <span className="bg-[#2c7852] text-white p-1">MERN Stack</span> Developer</p>
            <p className="text-gray-300 text-xl mx-40 px-36 h-20">I am a passionate fresher in front-end web development, skilled in HTML, CSS, and JavaScript. I enjoy creating responsive, visually appealing, and user-friendly websites</p>
        </div>
